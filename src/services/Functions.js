const url = "https://cors-anywhere.herokuapp.com/https://trafficticketlookup.gov.jm/api/traffic-tickets";
export const getData = async (data) => {
    try {
        // https://cors-anywhere.herokuapp.com/https://api.ipify.org?format=json
        const ipAddressResponse = await fetch("https://cors-anywhere.herokuapp.com/https://api.ipify.org?format=json");
        const mappedData = {
        ...
        const response = await fetch(url + (mappedData.type ? `/${mappedData.type}` : ""), {
            method: "POST",
            headers: headers,
